...
export default function Layout({ children }: LayoutProps) {
  const { navigateToDiary, navigateToPicture, navigateToHome, isActiveTab } =
    useLinkRouting();
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        {/* Gap - Header가 보일 때만 */}
        {isHeaderVisible && <div className={styles.gap}></div>}
        ...
        {/* Gap - Banner가 보일 때만 */}
        {isBannerVisible && <div className={styles.gap}></div>}
        ...
        <footer className={styles.footer}>
          <div className={styles["footer-content"]}>
            ...
            <div className={styles["footer-info"]}>
              <p className={styles["footer-representative"]}>
                대표 : {"{name}"}
              </p>
